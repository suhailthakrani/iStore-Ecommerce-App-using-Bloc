...
class _PaymentPageState extends State<PaymentPage> {
          ...
          child: Column(
            ...
            children: [
              ...
              CupertinoTextField(
                ...
                onChanged: (value) {
                  context.read<PaymentBloc>().add(PaymentTextFieldsChangedEvent(
              ...
              _dropDown(
                      ...
                      context.read<PaymentBloc>().paymentRepository.countries),
              const SizedBox(height: 10),
              ...
              ElevatedButton(
                onPressed: () {
                  context.read<PaymentBloc>().add(
                        PaymentButtonPressedEvent(
                        
                          name: _nameController.text,
                          email:  _emailController.text,
                          cardNumber: _cardController.text,
                          expiryDate: _expiryDateController.text,
                          cvcNo: _cvcController.text,
                ...
                child: BlocListener<PaymentBloc, PaymentState>(
                  listener: (context, state) {
                    if (state is PaymentNavigateState) {
  ...
  Text headerText(String text) {
   ...
   Widget _dropDown(List<String> countries) {
    return Container(
      height: 48,
      decoration: BoxDecoration(
        color: Colors.white,
