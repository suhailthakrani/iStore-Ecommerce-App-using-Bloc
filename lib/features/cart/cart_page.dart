                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                state is CartItemQuantityChangedState? Text("\$ $price", style: const TextStyle(
                                  fontSize: 14,
                                  fontWeight: FontWeight.w600,
                            ...
                            Row(
                              ...
                              children: [
                                ElevatedButton(
                                  style: IconButton.styleFrom(backgroundColor: Colors.pink.shade50, padding: const EdgeInsets.all(2),),
                                  onPressed: () {
                              ...
                              state is CartItemQuantityChangedState? Text("${product.quantity}", style: const TextStyle(
                                  fontSize: 14,
                                  fontWeight: FontWeight.w600,
